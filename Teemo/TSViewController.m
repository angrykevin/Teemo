...
- (void)push:(id)sender
{
//  UIAlertView *av = [[UIAlertView alloc] initWithTitle:@"ttl"
//                                               message:@"msg"
//                                              delegate:nil
//                                     cancelButtonTitle:@"ccl"
//                                     otherButtonTitles:@"oth1", nil];
//  [av show];
  
  TBAlertView *av = [[TBAlertView alloc] initWithMessage:@"HAHA"];
  [av addButtonWithTitle:@"aaa" block:^{ NSLog(@"aaa"); }];
  [av addCancelButtonWithTitle:@"ccc" block:NULL];
  [av show];
